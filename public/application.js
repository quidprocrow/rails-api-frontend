...
// Gets an item.
var getItem = function getItem(getMe) {
  return $.ajax({
...
var config = {
  apiOrigins: {
    production: 'https://shrouded-wave-18009.herokuapp.com/',
...
var showListTemplate = __webpack_require__(19);
var indexListTemplate = __webpack_require__(36);
...
var getItemsSuccess = function getItemsSuccess(data) {
  if (data.items.length > 0) {
    var getMe = data.items[Math.floor(Math.random() * Math.floor(data.items.length))].id;
    api.getItem(getMe).then(getItemSuccess).catch(getItemFailure);
  } else {
    var userGreet = store.user.email.split('@');
...
var itemUpdateFailure = function itemUpdateFailure(data) {
...
// Remove list success.
var removeListSuccess = function removeListSuccess() {
  api.getListIndex().then(indexListSuccess).catch(indexListFailure);
};

// Index Lists.
var indexListSuccess = function indexListSuccess(data) {
  if (data.lists.length > 0) {
    var indexListHtml = indexListTemplate({ lists: data.lists });
...
// Index Lists.
var indexListFailure = function indexListFailure() {
...
// Display the fact of an error to the user.
var createListFailure = function createListFailure(data) {
...
var getListSuccess = function getListSuccess(data) {
  ...
  $('#create-list-notification').html('');
  $('#proile-error').html('');
  var showListHtml = showListTemplate({ items: data.list.items });
  $('#write-list-area').html(showListHtml);
};

// Display the fact of an error to the user.
var getListFailure = function getListFailure(data) {
...
var createItemSuccess = function createItemSuccess(data) {
  ...
  api.getList().then(getListSuccess).catch(getListFailure);
};
...
// Get list success.
var getOldListSuccess = function getOldListSuccess(data) {
...
// Display the fact of an error to the user.
var getOldListFailure = function getOldListFailure(data) {
  var errorHtml = '<p>\n    <b>Oops!</b> There\'s been an error!\n    </p>\n    ';
...
module.exports = {
  ...
  removeListSuccess: removeListSuccess,
  getOldListSuccess: getOldListSuccess,
  getOldListFailure: getOldListFailure,
  itemUpdateFailure: itemUpdateFailure,
  getItemsSuccess: getItemsSuccess,
  indexListFailure: indexListFailure
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var listEvents = __webpack_require__(37);
...
var listApi = __webpack_require__(4);
var listUi = __webpack_require__(6);
var store = __webpack_require__(2);

var onNvmHover = function onNvmHover() {
  $('#list-directions').html('RELOAD UNEDITED LIST');
};

var onNvmOff = function onNvmOff() {
  $('#list-directions').html('PRESS ENTER TO EDIT');
};

var onDeleteHover = function onDeleteHover() {
  $('#hover-directions').html('DUST THAT LIST');
  $('#list-directions').html('DESTROY IT');
};

var onDeleteOff = function onDeleteOff() {
  $('#hover-directions').html('TO BE DONE');
  $('#list-directions').html('PRESS ENTER TO EDIT');
};

var onLoadHover = function onLoadHover() {
  $('#hover-directions').html('ADD TASKS');
};

var onLoadOff = function onLoadOff() {
  $('#hover-directions').html('TO BE DONE');
};

// User is directed to create a new list.
var yellingRedirect = function yellingRedirect() {
  $('#two-player').hide();
  $('#profile').hide();
  $('#game-board').hide();
  $('#change-pass').hide();
...
var indexListRedirect = function indexListRedirect() {
  $('#two-player').hide();
  $('#credit').hide();
  $('#instructions').hide();
  $('#game-board').hide();
  ...
  $('#create-list-notification').html('');
  $('#proile-error').html('');
  listApi.getListIndex().then(listUi.indexListSuccess).catch(listUi.indexListFailure);
};
...
// User is directed to create a new list.
var createListRedirect = function createListRedirect() {
  $('#two-player').hide();
  $('#profile').hide();
  $('#game-board').hide();
  $('#change-pass').hide();
...
module.exports = {
  ...
  onDeleteOff: onDeleteOff,
  onDeleteHover: onDeleteHover,
  onLoadOff: onLoadOff,
  onLoadHover: onLoadHover,
  onNvmOff: onNvmOff,
  onNvmHover: onNvmHover
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n\n    <p class=\"center item-changer\" data-id=\""
  ...
  return "<div class=\"center\" style=\"text-transform: uppercase;\">\n"
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n\n    <div class=\"list-box\"><p class=\"remove-list\" style=\"float: right;\" data-id="
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + ">X</p> <div class=\"load-list\" data-id="
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + ">"
...
var yellAtMe = function yellAtMe(event) {
  event.preventDefault();
  api.getItems().then(ui.getItemsSuccess).catch(ui.getItemFailure);
};

var onRemoveItemClick = function onRemoveItemClick(event) {
  event.preventDefault();
  var data = event.target;
  data = $(event.target).data('id');
  api.deleteItem(data).then(ui.createItemSuccess).catch(ui.getOldListFailure);
};

var onItemUpdate = function onItemUpdate(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  ...
  api.updateItem(data).then(ui.createItemSuccess).catch(ui.itemUpdateFailure);
};

var onNvmClick = function onNvmClick() {
  $('#write-list-notification').html('');
  api.getList().then(ui.getListSuccess).catch(ui.getListFailure);
};
...
var onLoadList = function onLoadList(event) {
  event.preventDefault();
  var data = event.target;
  data = $(event.target).data('id');
  store.newList = {};
  store.newList.id = data;
  api.getList().then(ui.getOldListSuccess).catch(ui.getOldListFailure);
};

var onRemoveList = function onRemoveList(event) {
  event.preventDefault();
  var data = event.target;
  data = $(event.target).data('id');
  api.deleteList(data).then(ui.removeListSuccess).catch(ui.getOldListFailure);
};
...
var createNewList = function createNewList(event) {
  ...
  var data = getFormFields(event.target);
  data = JSON.stringify(data);
  api.createList(data).then(ui.createListSuccess).catch(ui.createListFailure);
  $('#create-list-form').find('input[type=text], textarea').val('');
};

var writeNewListItem = function writeNewListItem(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  data.item.archived = 'off';
  data.item.list_id = store.newList.id;
  data = JSON.stringify(data);
  api.createItem(data).then(ui.createItemSuccess).catch(ui.createItemFailure);
};

// Add list specific handlers.
var addListHandlers = function addListHandlers() {
